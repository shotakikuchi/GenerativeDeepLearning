...
class CycleGAN():
    ...
    def compile_models(self):
        ...
        # Translate images back to the other domain
        ...
        # Combined model trains generator to fool discriminators
    ...
    def train_discriminators(self, imgs_A, imgs_B, valid, fake):
        ...
        # Train the discriminators (original image = Real / translated = Fake)
    ...
    def sample_images(self, data_loader, batch_i, run_folder, test_A_file, test_B_file):
        ...
        for p in range(2):
            ...
            if p == 1:
                ...
                #     '%s/%s/testA/%s' % (data_loader.dataset_dir, data_loader.dataset_name, test_A_file))
                # imgs_B = data_loader.load_img(
                #     '%s/%s/testB/%s' % (data_loader.dataset_dir, data_loader.dataset_name, test_B_file))
